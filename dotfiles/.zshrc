...
export SBT_OPTS='-Djava.security.egd=file:/dev/./urandom'
export JAVA_OPTS='-XX:+CMSClassUnloadingEnabled -XX:MaxMetaspaceSize=512m -Xmx1024m'
...
testroutes() {
    sbt -Dapplication.router=testOnlyDoNotUseInAppConf.Routes "run $1"
}
